...
```{r code_folding = TRUE}
#load the data
ddos <- read_csv("./data/fckptn_cumulative_observations.csv")
#summarize the data
options(scipen = 999)
summary(ddos)
```
...
```{r code_folding = TRUE}
#load the data
ddos <- read_csv("./data/fckptn active observations.csv")
...
ddos_final <- read_csv("data/fckptn_cumulative_observations.csv")
ddos_df <- ddos_final %>% 
