...
ivs_subset <- select(ivs_data,10,13,31,33,34,35,40:50,106,109:114,119:138,143:171,188:201,210:231)
ivs_df <- as.data.frame(ivs_subset)
head(ivs_df[1:5])
#save as csv file
write.csv(ivs_df,"./data/ivs_df.csv", row.names = TRUE)
```
...
head(ivs_df[50:54])
write.csv(ivs_df,"./data/ivs_df_names.csv", row.names = TRUE)
```
